    ...
    <div class="contentment">
        ...
        <section class="content">
            <div class="resume-header-main">
                ...
                <p>Мужчина, 21 год, родился 10 декабря 2001</p>
            </div>
            ...
            <div class="content__about-me">
                ...
                <p>
                    Я учусь в Севастопольском государственном институте на 4 курсе. На данный момент в коммерческих проектах не участвовал, но есть большое желание. На данный момент знания беру в университете, а также стараюсь учиться дома. На протяжении двух лет изучаю язык программирования PHP, в данный момент осваиваю фреймворк к этому языку(symfony), поверхностно изучал SQL. Также знаю основы верстки (html/css/bootstrap). В планах изучить Javascript. В институте изучаю С++ и Python. В рамках дисциплины Инженерный проект в университете, разрабатывали небольшое приложение по поиску изображений. После 3 курса проходил летнюю практику в компании "1С-Рарус", разрабатывал сервис Телефонии для api Битрикса, с чем успешно справился. Есть большое желание работать и развиваться в IT.
                </p>
            </div>
